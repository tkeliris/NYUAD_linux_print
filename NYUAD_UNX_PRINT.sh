...
sudo apt-get install cups printer-driver-hpcups printer-driver-postscript-hp python python-wxgtk3.0 python-wxtools wx3.0-i18n libwxgtk3.0-dev libgtk2.0-dev
